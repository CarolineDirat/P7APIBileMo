 ...
 */
final class Version20201007114715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (bm_id INT AUTO_INCREMENT NOT NULL, bm_username VARCHAR(180) NOT NULL, bm_roles JSON NOT NULL, bm_password VARCHAR(255) NOT NULL, bm_uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', bm_email VARCHAR(200) NOT NULL, bm_createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bm_updatedAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_C744045577B1466C (bm_username), UNIQUE INDEX UNIQ_C74404557F574996 (bm_uuid), UNIQUE INDEX UNIQ_C7440455C1E564C1 (bm_email), PRIMARY KEY(bm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE phone (bm_id INT AUTO_INCREMENT NOT NULL, size_bm_id INT DEFAULT NULL, screen_bm_id INT DEFAULT NULL, bm_created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bm_updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bm_constructor VARCHAR(55) NOT NULL, bm_priceEuro DOUBLE PRECISION NOT NULL, bm_system VARCHAR(45) DEFAULT NULL, bm_user_interface VARCHAR(45) DEFAULT NULL, bm_processor VARCHAR(45) DEFAULT NULL, bm_ram VARCHAR(6) DEFAULT NULL, bm_capacity VARCHAR(10) DEFAULT NULL, bm_das VARCHAR(15) DEFAULT NULL, bm_battery_capacity VARCHAR(10) DEFAULT NULL, bm_wireless_charging TINYINT(1) DEFAULT NULL, bm_weight VARCHAR(10) DEFAULT NULL, bm_uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', UNIQUE INDEX UNIQ_444F97DD7F574996 (bm_uuid), UNIQUE INDEX UNIQ_444F97DDA44C22FB (size_bm_id), UNIQUE INDEX UNIQ_444F97DD89BC088 (screen_bm_id), PRIMARY KEY(bm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (bm_id INT AUTO_INCREMENT NOT NULL, client_bm_id INT NOT NULL, bm_uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', bm_email VARCHAR(200) NOT NULL, bm_password VARCHAR(255) NOT NULL, bm_firstname VARCHAR(45) NOT NULL, bm_lastname VARCHAR(45) NOT NULL, bm_created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bm_updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D6497F574996 (bm_uuid), UNIQUE INDEX UNIQ_8D93D649C1E564C1 (bm_email), INDEX IDX_8D93D649D6F17C7B (client_bm_id), PRIMARY KEY(bm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE phone ADD CONSTRAINT FK_444F97DDA44C22FB FOREIGN KEY (size_bm_id) REFERENCES size (bm_id)');
        $this->addSql('ALTER TABLE phone ADD CONSTRAINT FK_444F97DD89BC088 FOREIGN KEY (screen_bm_id) REFERENCES screen (bm_id)');
